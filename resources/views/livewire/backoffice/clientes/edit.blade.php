<div class="flex flex-col gap-4">
    <x-header title="Editar Cliente - {{ $nome_razao_social }}" icon="s-building-office-2" separator />
    ...
    <div class="flex flex-col gap-8 w-full bg-white p-4 rounded-lg shadow-md">
        <form wire:submit.prevent="save" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <x-datetime label="Data de Início" wire:model="data_inicio_contrato" required />
                <x-datetime label="Data de Término" wire:model="data_fim_contrato" />
